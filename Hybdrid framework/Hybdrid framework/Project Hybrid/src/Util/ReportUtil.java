...
public class ReportUtil {
	...
	public static void main(String[] arg) throws Exception {
		...
		Xls_Reader suiteXLS = new Xls_Reader(
				System.getProperty("user.dir") + "//src//XLS//Suite.xlsx");
		...
		try {
			...
			// out.write("<tr><td width=20% align= center><FONT COLOR=#153E7E
			// FACE= Arial SIZE=2><b>TC04</b></td><td width=40% align=
			// center><FONT COLOR=#153E7E FACE= Arial SIZE=2><b>TC04</b></td><td
			// width=10% align=center bgcolor=yellow><FONT COLOR=153E7E
			// FACE=Arial SIZE=2><b>Skip</b></td></tr>");
			...
			for (int currentSuiteID = 2; currentSuiteID <= totalTestSuites; currentSuiteID++) {
				...
				/*
				 * out_suite_index.write("<html><HEAD> <TITLE>"
				 * +currentTestSuite+
				...
				for (int currentTestCaseID = 2; currentTestCaseID <= current_suite_xls
					...
					currentTestName = current_suite_xls.getCellData(Constants.TEST_CASES_SHEET, Constants.TCID,
							currentTestCaseID);
					...
					for (int rowNum = 2; rowNum <= rows; rowNum++) {
						...
						for (int colNum = 0; colNum < cols; colNum++) {
							...
							result_col = current_suite_xls.getCellData(Constants.TEST_STEPS_SHEET, colNum, 1)
					 ...
					 * out_suite_index.write(
					 * "</b></td><td width=10% align=center  bgcolor=");
					 * if(!currentTestRunmode.equalsIgnoreCase(Constants.
					 * RUNMODE_YES)) out_suite_index.write(
				...
				out.write(
						"<a href=" + currentTestSuite.replace(" ", "%20") + "_steps.html>" + currentTestSuite + "</a>");
